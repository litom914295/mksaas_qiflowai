        ...
        <div className="rounded-2xl border bg-card p-8 text-center shadow-lg">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <div>
              ...
              <div className="text-muted-foreground">核心功能模块</div>
            </div>
            <div>
              <div className="mb-2 text-4xl font-bold text-primary">100%</div>
              <div className="text-muted-foreground">TypeScript覆盖率</div>
            </div>
            <div>
              <div className="mb-2 text-4xl font-bold text-primary">95+</div>
              <div className="text-muted-foreground">Lighthouse评分</div>
            </div>
            <div>
