              ...
              <div className="flex items-center gap-4">
                <Badge className={`
                  ${analysisScore >= 80 ? 'bg-green-500' : 
                    analysisScore >= 60 ? 'bg-blue-500' : 
                    analysisScore >= 40 ? 'bg-yellow-500' : 'bg-red-500'}
                `}>
        ...
        <div className="text-center mb-12">
          ...
          <div className='grid grid-cols-1 md:grid-cols-5 gap-4 mb-8'>
            ...
            >
              ...
              <h4 className='font-semibold text-yellow-900 text-sm'>家宅风水</h4>
          ...
          <div className='mt-12'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
              ...
              >
                ...
                <h4 className='text-xl font-bold mb-2 text-gray-900 dark:text-gray-100'>专业算法</h4>
              ...
              >
                ...
                <h4 className='text-xl font-bold mb-2 text-gray-900 dark:text-gray-100'>个性化建议</h4>
                <p className='text-gray-600 dark:text-gray-300'>
              ...
              >
                ...
                <h4 className='text-xl font-bold mb-2 text-gray-900 dark:text-gray-100'>隐私保护</h4>
                <p className='text-gray-600 dark:text-gray-300'>
