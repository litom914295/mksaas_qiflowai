...
import { useCostMonitoring, useCostAlerts } from '@/lib/qiflow/hooks/useCostMonitoring';
...
export default function MonitoringPage() {
  ...
  const perRequestPercent = (usage.perRequest.used / usage.perRequest.limit) * 100;
  ...
  return (
    <div className="container mx-auto px-4 py-8">
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span>已用</span>
                <span className="font-mono">${usage.perRequest.used.toFixed(2)}</span>
              </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span>已用</span>
                <span className="font-mono">${usage.perReport.used.toFixed(2)}</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div 
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span>已用</span>
                <span className="font-mono">${usage.hourly.used.toFixed(2)}</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div 
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-2">
              <div className="flex justify-between text-sm">
                <span>已用</span>
                <span className="font-mono">${usage.daily.used.toFixed(2)}</span>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                <div 
        ...
        <CardContent>
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-muted-foreground mt-1">可生成报告数</div>
              <div className="font-semibold">
                (按$0.35/份计算)
              </div>
            </div>
      ...
      <div className="mt-6 text-sm text-muted-foreground">
        <p>📊 数据每10秒自动更新</p>
        <p>🔄 成本数据在每个自然小时/天重置</p>
        <p>⚡ 详细文档参见：<code>@LAUNCH_PERFORMANCE_MONITORING.md</code></p>
      </div>
    </div>
  );
}
