...
import { generateFullReport_v2_2 } from '@/lib/report/report-generator-v2.2';
...
export async function POST(req: NextRequest) {
  try {
    ...
    // 1) 生成 v2.2 报告对象
    const report = await generateFullReport_v2_2(baziInput as any, fengshuiInput as any, userContext || {});
    ...
    const viewUrl = `/reports/${row.id}/v2_2`;
