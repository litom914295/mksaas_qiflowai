...
const tianganAvatars: DefaultAvatar[] = [
  ...
  },
  {
    ...
    name: '辛',
    symbol: '辛',
    color: 'bg-gradient-to-br from-gray-300 to-zinc-400',
    description: '金之阴，革新之力',
  },
  {
    id: 'ren',
    category: 'tiangan',
...
const dizhiAvatars: DefaultAvatar[] = [
  ...
  },
  {
    ...
    name: '酉',
    symbol: '酉',
    color: 'bg-gradient-to-br from-gray-400 to-zinc-500',
    description: '酉金，秋季第二月',
  },
  {
    id: 'xu',
    category: 'dizhi',
    name: '戌',
    symbol: '戌',
    color: 'bg-gradient-to-br from-yellow-600 to-red-700',
    description: '戌土，秋季第三月',
  },
  {
    id: 'hai',
    category: 'dizhi',
...
const wuxingAvatars: DefaultAvatar[] = [
  {
    ...
    name: '金',
    symbol: '金',
    color: 'bg-gradient-to-br from-gray-300 to-yellow-400',
    description: '肃杀收敛，义之象',
  },
  {
    id: 'mu',
    category: 'wuxing',
