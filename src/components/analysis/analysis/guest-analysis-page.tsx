...
import type { LuckPillarAnalysis } from '@/lib/qiflow/bazi/luck-pillars';
import {
    generateFlyingStar,
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div>
              ...
              <input
                ...
                onChange={e =>
                  setCompassOrientation(parseFloat(e.target.value))
                }
                required
                className='w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'
    ...
    <div className='space-y-8'>
      ...
      {analysisData?.baziResult && (
        <Card className="p-8 shadow-xl bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 backdrop-blur-sm border-2 border-purple-200">
          ...
          <BaziAnalysisResult
            birthData={{
              datetime: `${analysisData.personal.birthDate}T${analysisData.personal.birthTime || '12:00:00'}`,
              gender: analysisData.personal.gender,
              timezone: 'Asia/Shanghai',
              isTimeKnown: !!analysisData.personal.birthTime,
            }}
        ...
        {currentStep <= 2 && (
          <div className='text-center mb-12'>
            <h2 className='text-4xl font-bold text-gray-900 mb-4'>
              {currentStep === 1 ? t('guestAnalysis.steps.discoverDestiny') : t('guestAnalysis.steps.determineLayout')}
            </h2>
