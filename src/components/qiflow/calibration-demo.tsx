          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            ...
            <ul className="text-sm space-y-2">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>智能触发</strong>:
                  仅在置信度0.4~0.7时显示，避免过度打扰
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-0.5">•</span>
                <span>
                  <strong>分步引导</strong>: 清晰的步骤说明，用户易于跟随
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-0.5">•</span>
                <span>
                  <strong>环境检查</strong>: 自动检测测量环境是否符合要求
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-0.5">•</span>
                <span>
                  <strong>可跳过</strong>: 用户可以选择跳过校准，使用当前结果
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-0.5">•</span>
                <span>
                  <strong>状态显示</strong>: 实时显示校准质量和影响因素
                </span>
              </li>
            </ul>
          </div>
