        ...
        <div className="lg:col-span-1">
          {showChat ? (
            <Card className="h-[600px] flex flex-col">
              ...
              <div className="flex-1 overflow-hidden p-6 flex flex-col items-center justify-center text-gray-600">
                <div className="max-w-md text-center space-y-4">
                  <h4 className="text-lg font-semibold text-gray-800">
                    AI对话功能
                  </h4>
                  <p className="text-sm">
                    基于您的八字分析结果，将为您提供智能问答服务。
                  </p>
                  <div className="p-4 bg-blue-50 rounded-lg text-left text-xs space-y-2">
                    <h5 className="font-medium text-blue-900">功能特点：</h5>
                    <ul className="space-y-1 text-blue-700">
                      <li>• 算法优先：基于真实八字数据分析</li>
                      <li>• 上下文感知：自动识别所需信息</li>
                      <li>• 个性化建议：结合风水和命理</li>
                    </ul>
                  </div>
