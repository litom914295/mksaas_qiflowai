      ...
      <Card className="w-full">
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center py-8 text-center">
            ...
            <p className="text-muted-foreground mb-2">尚未生成本月运势</p>
        ...
        <div className="grid grid-cols-3 gap-4 pt-2">
          ...
          {fortune.luckyColors && fortune.luckyColors.length > 0 && (
            <div>
              ...
              <p className="text-sm font-medium">{fortune.luckyColors[0]}</p>
            </div>
          )}
          {fortune.luckyNumbers && fortune.luckyNumbers.length > 0 && (
            <div>
              <p className="text-xs text-muted-foreground mb-1">幸运数字</p>
              <p className="text-sm font-medium">{fortune.luckyNumbers[0]}</p>
            </div>
          )}
        </div>
      </CardContent>
