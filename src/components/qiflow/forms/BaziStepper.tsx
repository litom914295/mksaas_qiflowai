...
import { type BaziInput, validateBaziInput } from '@/app/api/bazi/schema';
...
const cities = [
  ...
  { name: '重庆', value: 'chongqing', lat: 29.563, lon: 106.5516 },
  { name: '南京', value: 'nanjing', lat: 32.0603, lon: 118.7969 },
];

export function BaziStepper({
  onSubmit,
  initialData = {},
  className,
}: BaziStepperProps) {
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 rounded-lg border p-4">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {formData.birthDate &&
                    format(new Date(formData.birthDate), 'yyyy年M月d日', {
                      locale: zhCN,
                    })}
                </span>
              </div>
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {cities.find(
                    (c) =>
                      c.lon === formData.longitude &&
                      c.lat === formData.latitude
                  )?.name || '自定义位置'}
                </span>
              </div>
            </div>
