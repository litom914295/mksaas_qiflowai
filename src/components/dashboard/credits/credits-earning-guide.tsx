          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-2">
              ...
              <ul className="text-sm text-blue-800 space-y-1">
                <li>• 每日坚持签到，可获得连续签到奖励加成</li>
                <li>• 邀请朋友注册时记得分享您的专属链接</li>
                <li>• 关注官方公告，不错过限时积分活动</li>
                <li>• 积分有有效期，请及时使用避免过期</li>
              </ul>
            </div>
          </div>
        </div>
