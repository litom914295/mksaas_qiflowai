...
export function EnhancedCreditPackages({
  ...
  const creditPackagesObj = useCreditPackages();
  const creditPackages = Object.values(creditPackagesObj).filter(
  ...
  return (
    <Card className={cn('w-full', className)} data-section="credit-packages">
      <CardHeader>
        <CardTitle className="text-lg font-semibold flex items-center gap-2">
          <CoinsIcon className="h-5 w-5 text-primary" />
          积分套餐
              ...
              >
                ...
                <CardContent className="space-y-4 p-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2 text-sm">
                      <CircleCheckBigIcon className="h-4 w-4 text-green-500" />
                      <span>{creditPackage.expireDays}天有效期</span>
                    </div>
                  </div>
