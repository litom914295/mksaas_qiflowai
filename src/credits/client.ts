...
export function getCreditPackagesInClient(): CreditPackage[] {
  ...
  console.warn(
    'getCreditPackagesInClient is deprecated. Use useCreditPackages() hook in your component instead.'
  );
  return [];
}
...
export function getCreditPackageByIdInClient(
  ...
  console.warn(
    'getCreditPackageByIdInClient is deprecated. Use useCreditPackages() hook in your component instead.'
  );
  return undefined;
}
