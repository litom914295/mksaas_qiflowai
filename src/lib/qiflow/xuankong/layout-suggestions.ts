...
const auspiciousCombinations: Record<string, LayoutSuggestion> = {
  ...
  '1-6': {
    ...
    description: '一白水星配六白金星，金水相生，文昌大旺。适合设置学习区域，有助于学业和事业发展，利于考试升学。',
  ...
  '1-8': {
    ...
    description: '一白水星配八白土星，财源广进。有利于财运，适合放置招财物品，利于经商置业。',
  ...
  '6-1': {
    ...
    description: '六白金星配一白水星，金水相生，事业运旺。有助于事业发展和升职加薪，利于领导力提升。',
  ...
  '8-1': {
    ...
    description: '八白土星配一白水星，土水和合，财运亨通。有利于财富积累和置业发展。',
  ...
  '4-9': {
    ...
    description: '四绿木星配九紫火星，木火通明，桃花大旺。有利于感情和人际关系，适合单身人士催旺姻缘。',
  ...
  '4-1': {
    ...
    description: '四绿木星配一白水星，水木相生，文艺兴旺。有利于文艺创作和才华发挥。',
  ...
  '8-8': {
    ...
    description: '双八白土星入中，双财星聚会，财源广进。大利财富积累和置业投资。',
  ...
  '8-6': {
    ...
    description: '八白土星配六白金星，土金相生，财文双美。有利于财运和学业，适合商务人士。',
  ...
  '6-8': {
    ...
    description: '六白金星配八白土星，土金相生，文财双收。有利于学业和财运，适合设置书房或办公区。',
  ...
  '9-4': {
    ...
    description: '九紫火星配四绿木星，木火通明，贵人运旺。有助于获得贵人相助，事业顺利。',
  ...
  '9-9': {
    ...
    description: '双九紫火星入中，喜上加喜，双喜临门。有利于各方面运势，特别利于喜事和名声。',
  ...
  '9-8': {
    ...
    description: '九紫火星配八白土星，火土相生，喜事财运两旺。有利于财运和喜庆之事。',
  ...
  '1-1': {
    ...
    title: '文昌贵人位',
    enhance: ['书桌', '文房四宝', '水晶', '绿植', '文昌塔'],
    description: '双一白水星入中，文昌大旺，智慧聪明。有利于学业和事业发展，适合设置书房。',
...
const inauspiciousCombinations: Record<string, LayoutSuggestion> = {
  ...
  '2-5': {
    ...
    description: '二黑土星配五黄土星，双土叠加，病灾严重。极易引起健康问题和意外伤害，必须化解。',
  ...
  '5-2': {
    ...
    description: '五黄土星配二黑土星，双煞并临，疾病丛生。易引起严重健康问题，家人体弱多病。',
  ...
  '2-2': {
    ...
    description: '双二黑土星入中，病星重叠，健康大忌。严重影响健康，易有慢性疾病，必须化解。',
    suitableRooms: ['储藏室', '杂物间'],
  ...
  '3-7': {
    ...
    description: '三碧木星配七赤金星，金木交战，口舌是非。易引起争吵、官司和人际纠纷。',
  ...
  '7-3': {
    ...
    description: '七赤金星配三碧木星，金克木，是非不断。易引起争吵、破财和官非，需要化解。',
    suitableRooms: ['储藏室', '杂物间'],
  ...
  '3-3': {
    ...
    description: '双三碧木星入中，是非星重叠，官非不断。易引起严重争吵、诉讼和人际问题。',
    suitableRooms: ['储藏室'],
    avoidRooms: ['客厅', '书房', '办公室', '会客区'],
    colorScheme: ['红色', '紫色', '粉色'],
  ...
  '5-5': {
    ...
    description: '双五黄土星入中，煞气极重，大凶之位。严重影响健康、财运和家宅平安，必须重点化解。',
    suitableRooms: ['储藏室'],
  ...
  '7-7': {
    ...
    description: '双七赤金星入中，肃杀之气过重。易引起严重争吵、官非、血光之灾，必须化解。',
    suitableRooms: ['储藏室', '杂物间'],
...
export function getLayoutSuggestion(
  ...
  return {
    ...
    dissolve: [],
    description: '此方位无特殊吉凶影响，可正常使用。建议保持整洁明亮，适当摆放绿植装饰。',
