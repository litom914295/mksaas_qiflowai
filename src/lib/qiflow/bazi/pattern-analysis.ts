...
import type { FiveElement, Pillars, Stem, Branch } from './types';
...
// 地支藏干系统（详细版本）
const BRANCH_HIDDEN_STEMS: Record<string, Array<{stem: string, strength: number}>> = {
...
// 季节调候用神表（基于《穷通宝鉴》）
const SEASONAL_ADJUSTMENTS: Record<string, Record<FiveElement, {
  primary: FiveElement[];
  ...
  // 春季（寅卯辰月）
  '寅': {
    '木': {primary: ['火'], secondary: ['水'], avoid: ['金'], principle: '春木向荣，喜火泄秀，用水济根，忌金克伐'},
    '火': {primary: ['木'], secondary: ['金'], avoid: ['水'], principle: '春火虚焰，用木生扶，金财为辅，忌水克制'},
    '土': {primary: ['火'], secondary: ['金'], avoid: ['木'], principle: '春土虚湿，用火暖土，金泄土气，忌木克伤'},
    '金': {primary: ['土'], secondary: ['火'], avoid: ['火'], principle: '春金软弱，用土生金，火炼成器，但不宜过旺'},
    '水': {primary: ['金'], secondary: ['土'], avoid: ['土'], principle: '春水泛滥，用金发水源，土制水势，过土则塞'}
  },
  '卯': {
    '木': {primary: ['火'], secondary: ['水'], avoid: ['金'], principle: '卯木当令，喜火显达，用水调济，忌金砍伐'},
    '火': {primary: ['木'], secondary: ['金'], avoid: ['水'], principle: '春火得木，势能舒展，金财为用，忌水浇灭'},
    '土': {primary: ['火'], secondary: ['金'], avoid: ['木'], principle: '春土喜暖，用火温土，金疏土质，忌木太旺'},
    '金': {primary: ['土'], secondary: ['火'], avoid: ['木'], principle: '春金失令，赖土滋生，火炼成材，忌木旺克金'},
    '水': {primary: ['金'], secondary: ['土'], avoid: ['土'], principle: '春水清澈，金水相涵，土适可止，不宜过厚'}
  },
  '辰': {
    '木': {primary: ['火'], secondary: ['金'], avoid: ['土'], principle: '辰为湿土，木喜火疏，金制为美，忌土重埋'},
    '火': {primary: ['木', '土'], secondary: ['金'], avoid: ['水'], principle: '辰月火进气，木土并用，金财相济，忌水克身'},
    '土': {primary: ['火'], secondary: ['金'], avoid: ['水'], principle: '辰土当令，用火燥土，金疏为佳，忌水湿重'},
    '金': {primary: ['火', '土'], secondary: ['水'], avoid: ['木'], principle: '辰月金墓，火土并举，水润有情，忌木克伤'},
    '水': {primary: ['金'], secondary: ['火'], avoid: ['土'], principle: '辰月水库，金发其源，火暖有生，忌土壅塞'}
  },
  
  // 夏季（巳午未月）
  '巳': {
    '木': {primary: ['水'], secondary: ['金'], avoid: ['火'], principle: '巳月木焦，最喜壬水，金发水源，火多则燥'},
    '火': {primary: ['土', '金'], secondary: ['水'], avoid: ['木'], principle: '巳火司权，土泄其势，金为财源，水济其威'},
    '土': {primary: ['金', '水'], secondary: ['火'], avoid: ['木'], principle: '夏土燥烈，金水润泽，火虽生土，过旺则焦'},
    '金': {primary: ['水'], secondary: ['土'], avoid: ['火'], principle: '夏金畏熔，最喜壬癸，土生有源，火旺则危'},
    '水': {primary: ['金'], secondary: ['土'], avoid: ['火'], principle: '夏水易干，赖金发源，土止有节，火炎则竭'}
  },
  '午': {
    '木': {primary: ['水'], secondary: ['金'], avoid: ['火'], principle: '午火炎炎，木焦叶萎，壬水为救，金水相济'},
    '火': {primary: ['土', '金'], secondary: ['水'], avoid: ['木'], principle: '午火当权，土金并用，水调有制，木助则炎'},
    '土': {primary: ['金', '水'], secondary: [], avoid: ['火'], principle: '夏土亢燥，金水双清，火旺土焦，不可再助'},
    '金': {primary: ['水'], secondary: ['土'], avoid: ['火'], principle: '午月金熔，非水不救，土生有情，火多必损'},
    '水': {primary: ['金'], secondary: ['土'], avoid: ['火'], principle: '夏水涸竭，金为水源，土止其流，火克为病'}
  },
  '未': {
    '木': {primary: ['水'], secondary: ['金'], avoid: ['土'], principle: '未土燥热，木根焦枯，水润为先，金发水源'},
    '火': {primary: ['土'], secondary: ['金', '水'], avoid: ['木'], principle: '火至未宫，土泄有情，金水相济，木助太燥'},
    '土': {primary: ['金', '水'], secondary: ['火'], avoid: ['木'], principle: '未土司令，金水润泽，火燥须制，忌木克伤'},
    '金': {primary: ['水'], secondary: ['土'], avoid: ['火'], principle: '夏末金柔，水洗成器，土生有根，火炼过头'},
    '水': {primary: ['金'], secondary: ['土'], avoid: ['土'], principle: '未月水弱，金生为美，土多则浊，不清不贵'}
  },
  
  // 秋季（申酉戌月）
  '申': {
    '木': {primary: ['水'], secondary: ['火'], avoid: ['金'], principle: '申金司权，木被克伐，水润有救，火暖有生'},
    '火': {primary: ['木'], secondary: ['土'], avoid: ['金', '水'], principle: '秋火渐微，木助其势，土泄有制，金水无情'},
    '土': {primary: ['火'], secondary: ['金'], avoid: ['木'], principle: '秋土子旺，火暖土温，金泄有情，忌木克伤'},
    '金': {primary: ['火'], secondary: ['水'], avoid: ['土'], principle: '申金当令，火炼成器，水泄有制，土生过厚'},
    '水': {primary: ['金'], secondary: ['木'], avoid: ['土'], principle: '秋水通源，金白水清，木疏土制，不宜壅塞'}
  },
  '酉': {
    '木': {primary: ['水', '火'], secondary: [], avoid: ['金'], principle: '酉金强旺，木最受伤，水火并用，方保其生'},
    '火': {primary: ['木'], secondary: ['土'], avoid: ['金', '水'], principle: '秋火衰微，专用甲木，土泄为病，金水敌对'},
    '土': {primary: ['火'], secondary: ['金'], avoid: ['水'], principle: '秋土金旺，火暖为妙，金泄有节，水湿无功'},
    '金': {primary: ['火'], secondary: ['水'], avoid: ['土'], principle: '酉金专旺，丁火必用，水泄成器，土重难清'},
    '水': {primary: ['金'], secondary: ['木'], avoid: ['土'], principle: '秋水得源，金水相涵，木疏有情，土厚为病'}
  },
  '戌': {
    '木': {primary: ['水'], secondary: ['金'], avoid: ['土'], principle: '戌为火库，木易被焚，壬水为救，金发水源'},
    '火': {primary: ['木'], secondary: ['金'], avoid: ['土'], principle: '火入戌库，木发其焰，金财相配，土多则晦'},
    '土': {primary: ['金', '火'], secondary: ['水'], avoid: ['木'], principle: '戌土当旺，金火并用，水润有节，忌木克伤'},
    '金': {primary: ['火', '水'], secondary: ['土'], avoid: ['木'], principle: '秋末金藏，火炼水洗，土生有根，木克为病'},
    '水': {primary: ['金'], secondary: ['火'], avoid: ['土'], principle: '戌月水库，金发为贵，火暖有生，土重难清'}
  },
  
  // 冬季（亥子丑月）  
  '亥': {
    '木': {primary: ['火'], secondary: ['金'], avoid: ['水'], principle: '亥水司权，木水伤官，火调暖局，金发水源'},
    '火': {primary: ['木'], secondary: ['土'], avoid: ['水'], principle: '冬火微弱，木助其焰，土泄有制，水多则灭'},
    '土': {primary: ['火'], secondary: ['金'], avoid: ['水'], principle: '冬土寒冻，火暖为先，金泄有节，水多则湿'},
    '金': {primary: ['火'], secondary: ['土'], avoid: ['水'], principle: '冬金寒冷，火暖为妙，土生有情，水冷金寒'},
    '水': {primary: ['火'], secondary: ['金'], avoid: ['金'], principle: '亥水当令，最喜火暖，金多水寒，不成大器'}
  },
  '子': {
    '木': {primary: ['火'], secondary: ['土'], avoid: ['水'], principle: '子水旺极，木漂不实，火暖成器，土止其流'},
    '火': {primary: ['木'], secondary: ['土'], avoid: ['水'], principle: '冬火遇水，木生为急，土制水势，方能成器'},
    '土': {primary: ['火'], secondary: ['木'], avoid: ['水'], principle: '冬土极寒，火暖为要，木疏为辅，水冻不流'},
    '金': {primary: ['火'], secondary: ['土'], avoid: ['水'], principle: '子月金寒，丙火解冻，土生有情，水冷无用'},
    '水': {primary: ['火'], secondary: ['土'], avoid: ['金'], principle: '子水专旺，火暖为贵，土制有节，金多反寒'}
  },
  '丑': {
    '木': {primary: ['火'], secondary: ['水'], avoid: ['土'], principle: '丑为湿土，木气不舒，丙火解冻，水润有生'},
    '火': {primary: ['木'], secondary: ['土'], avoid: ['水'], principle: '冬火衰微，甲木为生，土泄有节，水克为病'},
    '土': {primary: ['火'], secondary: ['金'], avoid: ['水'], principle: '丑土湿寒，火暖燥土，金泄有情，水湿为病'},
    '金': {primary: ['火'], secondary: ['水'], avoid: ['土'], principle: '丑月金库，火炼成器，水洗有节，土厚金埋'},
    '水': {primary: ['火'], secondary: ['金'], avoid: ['土'], principle: '冬末水寒，火暖为先，金发有源，土厚则浊'}
  }
};
...
function analyzeStandardPattern(pillars: Pillars): {
  ...
  // 按藏干强度排序，找主要十神
  const sortedGods = transparency.hiddenGods
  ...
  switch (primaryGod.god) {
    case '正官':
      pattern = '正官格';
      usefulGods = ['正印', '食神', '正财'];
      formation.push(`月令${monthBranch}藏${primaryGod.stem}为正官，以正官格论`);
      break;
      
    case '偏官':
      pattern = '偏官格';
      usefulGods = ['食神', '正印', '劫财'];
      formation.push(`月令${monthBranch}藏${primaryGod.stem}为偏官，以偏官格论`);
      break;
      
    case '正财':
      pattern = '正财格';
      usefulGods = ['正官', '食神', '比肩'];
      formation.push(`月令${monthBranch}藏${primaryGod.stem}为正财，以正财格论`);
      break;
      
    case '偏财':
      pattern = '偏财格';
      usefulGods = ['偏官', '伤官', '劫财'];
      formation.push(`月令${monthBranch}藏${primaryGod.stem}为偏财，以偏财格论`);
      break;
      
    case '食神':
      pattern = '食神格';
      usefulGods = ['偏财', '正印'];
      formation.push(`月令${monthBranch}藏${primaryGod.stem}为食神，以食神格论`);
      break;
      
    case '伤官':
      pattern = '伤官格';
      usefulGods = ['正财', '正印'];
      formation.push(`月令${monthBranch}藏${primaryGod.stem}为伤官，以伤官格论`);
      break;
      
    case '正印':
      pattern = '正印格';
      usefulGods = ['偏官', '伤官'];
      formation.push(`月令${monthBranch}藏${primaryGod.stem}为正印，以正印格论`);
      break;
      
    case '偏印':
      pattern = '偏印格';
      usefulGods = ['偏财', '食神'];
      formation.push(`月令${monthBranch}藏${primaryGod.stem}为偏印，以偏印格论`);
      break;
      ...
      if (primaryGod.god === '比肩' || primaryGod.god === '劫财') {
        ...
        for (let i = 1; i < sortedGods.length; i++) {
          ...
          if (secondaryGod.god !== '比肩' && secondaryGod.god !== '劫财') {
            ...
            formation.push(`月令虽以${primaryGod.god}为主，但取${secondaryGod.god}为格`);
            confidence -= 15; // 降低置信度
            break;
          }
        }
  ...
  if (transparency.isTransparent) {
    const transparentGod = transparency.transparentStems.find(stem => 
      stem === primaryGod.stem
    );
    if (transparentGod) {
      confidence += 20;
 ...
 * 检查格局破坏因素
 */
function checkPatternDestruction(pillars: Pillars, patternGod: TenGod, destruction: string[]): void {
  const dayMaster = pillars.day.stem;
  const allStems = [
    pillars.year.stem,
    pillars.month.stem,
...
function analyzeFollowPattern(pillars: Pillars): {
  ...
  if (!followType) {
    ...
    if (maxElement && maxElement[1] >= 3) {
      ...
      // 根据从势的五行确定用神
      usefulGods = getUsefulGodsForElement(dayMaster, maxElement[0] as FiveElement);
    }
  }
  ...
  if (followType) {
    ...
    // 检查是否有生扶日主的因素
    const supportCount = (godCounts['比肩'] || 0) + (godCounts['劫财'] || 0) + 
                        (godCounts['正印'] || 0) + (godCounts['偏印'] || 0);
    if (supportCount > 0) {
 ...
 * 获取某五行对应的有用十神
 */
function getUsefulGodsForElement(dayMaster: string, element: FiveElement): TenGod[] {
  const allStems = ['甲', '乙', '丙', '丁', '戊', '己', '庚', '辛', '壬', '癸'];
  const elementStems = allStems.filter(stem => STEM_ELEMENTS[stem] === element);
  
  return elementStems.map(stem => getTenGod(dayMaster, stem))
...
function analyzeTransformPattern(pillars: Pillars): {
  ...
  const transformations: Record<string, {
    ...
    '甲': { partner: '己', result: '土', name: '甲己化土', conditions: ['需要土旺之时', '辰戌丑未月最佳'] },
    '己': { partner: '甲', result: '土', name: '甲己化土', conditions: ['需要土旺之时', '辰戌丑未月最佳'] },
    '乙': { partner: '庚', result: '金', name: '乙庚化金', conditions: ['需要金旺之时', '申酉月最佳'] },
    '庚': { partner: '乙', result: '金', name: '乙庚化金', conditions: ['需要金旺之时', '申酉月最佳'] },
    '丙': { partner: '辛', result: '水', name: '丙辛化水', conditions: ['需要水旺之时', '亥子月最佳'] },
    '辛': { partner: '丙', result: '水', name: '丙辛化水', conditions: ['需要水旺之时', '亥子月最佳'] },
    '丁': { partner: '壬', result: '木', name: '丁壬化木', conditions: ['需要木旺之时', '寅卯月最佳'] },
    '壬': { partner: '丁', result: '木', name: '丁壬化木', conditions: ['需要木旺之时', '寅卯月最佳'] },
    '戊': { partner: '癸', result: '火', name: '戊癸化火', conditions: ['需要火旺之时', '巳午月最佳'] },
    '癸': { partner: '戊', result: '火', name: '戊癸化火', conditions: ['需要火旺之时', '巳午月最佳'] }
  };
  ...
  // 检查化合条件
  formation.push(`${transformation.name}：${dayMaster}与${transformation.partner}相合`);
  
  // 检查月令是否有利于化合
  const resultElement = transformation.result;
  if (monthElement === resultElement) {
    confidence += 30;
    formation.push(`月令${monthBranch}为${monthElement}，有利于化${resultElement}`);
  } else {
    confidence -= 15;
    formation.push(`月令${monthBranch}为${monthElement}，不利化${resultElement}`);
  }
  ...
  const supportingBranches = allBranches.filter(branch => 
    BRANCH_ELEMENTS[branch] === resultElement
  );
 ...
 * 获取化格用神
 */
function getTransformPatternUsefulGods(dayMaster: string, transformation: any): TenGod[] {
  const resultElement = transformation.result;
...
function getProductionChain(element: FiveElement): FiveElement[] {
  ...
  const mother = Object.entries(production).find(([k, v]) => v === element)?.[0] as FiveElement;
 ...
 * 检查木局格局
 */
function checkWoodPattern(pillars: Pillars, stemElements: Record<FiveElement, number>, branchElements: Record<FiveElement, number>): boolean {
  const branches = [pillars.year.branch, pillars.month.branch, pillars.day.branch, pillars.hour.branch];
  
  // 寅卯辰三会木局
  if (branches.includes('寅') && branches.includes('卯') && branches.includes('辰')) {
    return true;
  }
 ...
 * 检查火局格局
 */
function checkFirePattern(pillars: Pillars, stemElements: Record<FiveElement, number>, branchElements: Record<FiveElement, number>): boolean {
  const branches = [pillars.year.branch, pillars.month.branch, pillars.day.branch, pillars.hour.branch];
  
  // 巳午未三会火局
  if (branches.includes('巳') && branches.includes('午') && branches.includes('未')) {
    return true;
  }
 ...
 * 检查水局格局
 */
function checkWaterPattern(pillars: Pillars, stemElements: Record<FiveElement, number>, branchElements: Record<FiveElement, number>): boolean {
  const branches = [pillars.year.branch, pillars.month.branch, pillars.day.branch, pillars.hour.branch];
  
  // 申子辰三合水局
  if (branches.includes('申') && branches.includes('子') && branches.includes('辰')) {
    return true;
  }
  
  // 亥子丑三会水局
  if (branches.includes('亥') && branches.includes('子') && branches.includes('丑')) {
    return true;
  }
 ...
 * 检查金局格局
 */
function checkMetalPattern(pillars: Pillars, stemElements: Record<FiveElement, number>, branchElements: Record<FiveElement, number>): boolean {
  const branches = [pillars.year.branch, pillars.month.branch, pillars.day.branch, pillars.hour.branch];
  
  // 巳酉丑三合金局
  if (branches.includes('巳') && branches.includes('酉') && branches.includes('丑')) {
    return true;
  }
  
  // 申酉戌三会金局
  if (branches.includes('申') && branches.includes('酉') && branches.includes('戌')) {
    return true;
  }
 ...
 * 检查土局格局
 */
function checkEarthPattern(pillars: Pillars, stemElements: Record<FiveElement, number>, branchElements: Record<FiveElement, number>): boolean {
  const branches = [pillars.year.branch, pillars.month.branch, pillars.day.branch, pillars.hour.branch];
  
  // 辰戌丑未四土全
  const earthBranches = ['辰', '戌', '丑', '未'];
  const earthCount = earthBranches.filter(eb => branches.includes(eb as Branch)).length;
...
export function analyzePattern(pillars: Pillars): PatternAnalysis {
  ...
  ].filter(r => r.pattern).sort((a, b) => b.confidence - a.confidence);
  ...
  if (allResults.length > 0) {
    ...
    destruction = best.type === 'standard' ? (best as any).destruction || [] : [];
  ...
  return {
    ...
    monthlyOrder: {
      ...
      god: primaryHiddenGod ? primaryHiddenGod.god : getTenGod(dayMaster, pillars.month.stem),
 ...
 * 生成用神说明
 */
function generateUsefulGodExplanation(pattern: string, usefulGods: TenGod[]): string {
