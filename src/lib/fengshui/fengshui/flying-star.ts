...
// 飞星吉凶属性
export const STAR_NATURE: Record<
  StarNumber,
  {
    name: string;
...
export class FlyingStarCalculator {
   ...
   * 生成飞星盘
   */
  private generateFlyingGrid(
    centerStar: StarNumber
  ): Record<Direction, StarNumber> {
   ...
   * 飞星组合分析
   */
  analyzeStarCombination(
    mountainStar: StarNumber,
    waterStar: StarNumber
  ): {
    combination: string;
