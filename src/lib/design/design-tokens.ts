...
export const variants = {
  ...
  card: {
    ...
    cultural:
      'rounded-xl border bg-gradient-to-br from-white to-amber-50 shadow-cultural',
  },
  ...
  button: {
    ...
    outline:
      'rounded-md border-2 border-primary-600 text-primary-600 hover:bg-primary-50',
    ghost: 'rounded-md text-primary-600 hover:bg-primary-50',
    cultural:
      'rounded-lg bg-gradient-to-r from-gold-500 to-gold-600 text-white shadow-cultural',
  },
