...
export class ThemeUtils {
  static getTheme(themeName: keyof typeof OPTIMIZED_COMPASS_THEMES): OptimizedCompassTheme {
  ...
  static createCustomTheme(baseTheme: keyof typeof OPTIMIZED_COMPASS_THEMES, overrides: Partial<OptimizedCompassTheme>): OptimizedCompassTheme {
