...
# 复制八字库（如果需要）
Copy-Item "D:\test\QiFlow AI_qiflowai\qiflow-ai\src\lib\bazi" `
          "D:\test\QiFlow AI_qiflowai\src\lib\bazi" -Recurse -Force
```
...
```powershell
# 复制所有类型定义
Copy-Item "D:\test\QiFlow AI_qiflowai\qiflow-ai\src\lib\*\types.ts" `
          "D:\test\QiFlow AI_qiflowai\src\lib\" -Recurse -Force
```
