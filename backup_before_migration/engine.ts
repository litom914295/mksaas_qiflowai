...
import { BaziInput, BaziOutput } from '@/app/api/bazi/schema';
 ...
 * 计算八字四柱
 */
export function calculateFourPillars(birthDate: Date, birthHour: number, gender: 'M' | 'F'): {
...
export function calculateMajorFortunes(
  ...
  // 判断顺行还是逆行
  const isForward = (gender === 'M' && yearStemIndex % 2 === 0) || 
