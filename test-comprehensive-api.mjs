...
try {
  ...
  console.log('\n高级格局数据:');
  console.log('  - 七星打劫:', result.qixingdajieAnalysis ? '✅ 存在' : '❌ null');
  console.log('  - 零正理论:', result.lingzhengAnalysis ? '✅ 存在' : '❌ null');
  console.log('  - 城门诀:', result.chengmenjueAnalysis ? '✅ 存在' : '❌ null');
