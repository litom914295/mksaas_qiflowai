...
if (-not $isAdmin) {
    ...
    Write-Host "   cd D:\test\mksaas_qiflowai" -ForegroundColor White
...
$projectPath = "D:\test\mksaas_qiflowai"
...
try {
    ...
    Write-Host "7. Select: D:\test\mksaas_qiflowai" -ForegroundColor White
    Write-Host ""
}
