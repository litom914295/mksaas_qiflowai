  ...
  try {
    ...
    const homeElements = await page.evaluate(() => {
      return {
        ...
        hasAgeVerification: !!document.querySelector(
    ...
    // Test 2: 八字分析页面
    console.log('\n📋 Test 2: 八字分析页面');
    await page.goto(`${BASE_URL}/zh/analysis/bazi`, {
    ...
    const baziElements = await page.evaluate(() => {
      return {
        ...
        hasCreditsPrice: !!document.querySelector(
          '[data-testid="credits-price"]'
        ),
        title: document.title,
      };
    });
    ...
    // Test 3: 玄空风水分析页面
    console.log('\n📋 Test 3: 玄空风水分析页面');
    await page.goto(`${BASE_URL}/zh/analysis/xuankong`, {
      waitUntil: 'networkidle0',
    });
