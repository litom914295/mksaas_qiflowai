...
async function applyMigration() {
  const sqlPath = path.join(process.cwd(), 'drizzle/0004_phase7_knowledge_base_1024dim.sql');
  ...
  log.info('\n执行步骤:');
  log.info('1. 访问: https://supabase.com/dashboard/project/sibwcdadrsbfkblinezj/sql/new');
