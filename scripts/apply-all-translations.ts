...
const zhTWTranslations: { [key: string]: string } = {
  ...
  'MkSaaS lets you make AI SaaS in days, simply and effortlessly':
    'MkSaaS 讓您輕鬆快速地在幾天內構建 AI SaaS',
  ...
  // About
  About: '關於',
  'This is MkSaaS, an AI SaaS template built with modern technologies, helping you build your SaaS faster and better.':
    '這是 MkSaaS，一個使用現代技術構建的 AI SaaS 模板，幫助您更快更好地構建 SaaS',
  'AI SaaS Boilerplate': 'AI SaaS 樣板',
  '👋 Hi there! This is MkSaaS, an AI SaaS template built with modern technologies, helping you build your SaaS faster and better. If you have any questions, welcome to contact me.':
    '👋 您好！這是 MkSaaS，一個使用現代技術構建的 AI SaaS 模板，幫助您更快更好地構建 SaaS。如有任何問題，歡迎聯繫我',
  'Talk with me': '與我交談',
...
const jaTranslations: { [key: string]: string } = {
  ...
  'MkSaaS lets you make AI SaaS in days, simply and effortlessly':
    'MkSaaS を使用すると、数日で簡単に AI SaaS を作成できます',
  'Analyze web content with AI to extract key information, features, and insights':
  ...
  About: '概要',
  'This is MkSaaS, an AI SaaS template built with modern technologies, helping you build your SaaS faster and better.':
    'これは MkSaaS です。最新技術で構築された AI SaaS テンプレートで、SaaS をより速く、より良く構築するのに役立ちます',
  'AI SaaS Boilerplate': 'AI SaaS ボイラープレート',
  '👋 Hi there! This is MkSaaS, an AI SaaS template built with modern technologies, helping you build your SaaS faster and better. If you have any questions, welcome to contact me.':
    '👋 こんにちは！これは MkSaaS です。最新技術で構築された AI SaaS テンプレートで、SaaS をより速く、より良く構築するのに役立ちます。ご質問がありましたら、お気軽にお問い合わせください',
  'Talk with me': '私と話す',
...
const msMyTranslations: { [key: string]: string } = {
  ...
  'MkSaaS lets you make AI SaaS in days, simply and effortlessly':
    'MkSaaS membolehkan anda membuat AI SaaS dalam beberapa hari, dengan mudah dan tanpa usaha',
  'Analyze web content with AI to extract key information, features, and insights':
  ...
  About: 'Tentang',
  'This is MkSaaS, an AI SaaS template built with modern technologies, helping you build your SaaS faster and better.':
    'Ini adalah MkSaaS, templat AI SaaS yang dibina dengan teknologi moden, membantu anda membina SaaS anda dengan lebih cepat dan lebih baik',
  'AI SaaS Boilerplate': 'Templat Asas AI SaaS',
  '👋 Hi there! This is MkSaaS, an AI SaaS template built with modern technologies, helping you build your SaaS faster and better. If you have any questions, welcome to contact me.':
    '👋 Hi! Ini adalah MkSaaS, templat AI SaaS yang dibina dengan teknologi moden, membantu anda membina SaaS anda dengan lebih cepat dan lebih baik. Jika anda mempunyai sebarang soalan, sila hubungi saya',
