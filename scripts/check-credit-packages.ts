...
console.log('免费用户是否可购买:', websiteConfig.credits.enablePackagesForFreePlan);
console.log('\n积分包配置:\n');
...
console.log('NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY:', process.env.NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY ? '✓ 已配置' : '✗ 未配置');
...
console.log('Enterprise:', process.env.NEXT_PUBLIC_STRIPE_PRICE_CREDITS_ENTERPRISE);
