# qiflowai Quick Start Script (Windows PowerShell)
# Usage: .\scripts\quick-start.ps1

Write-Host "================================" -ForegroundColor Cyan
Write-Host "  qiflowai Admin Panel Starter   " -ForegroundColor Cyan
Write-Host "================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "    Email: admin@qiflowai.com" -ForegroundColor Gray
Write-Host "    Password: admin123456" -ForegroundColor Gray
Write-Host ""
Write-Host "  Manager" -ForegroundColor Cyan
Write-Host "    Email: manager@qiflowai.com" -ForegroundColor Gray
