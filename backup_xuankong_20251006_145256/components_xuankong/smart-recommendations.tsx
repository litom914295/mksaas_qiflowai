...
function RecommendationCard({
  ...
  return (
    <Card
      className={`p-4 border-2 ${typeColors[recommendation.type as keyof typeof typeColors]}`}
    >
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <CategoryIcon
                    className={`w-4 h-4 ${categoryColors[recommendation.category as keyof typeof categoryColors]}`}
                  />
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="text-center">
          <div className="text-2xl font-bold text-blue-600">
            {stats.typeCounts.suggestion || 0}
          </div>
          <div className="text-xs text-gray-600">建议</div>
        </div>
        <div className="text-center">
          <div className="text-2xl font-bold text-green-600">
            {stats.typeCounts.enhancement || 0}
          </div>
...
export function SmartRecommendations({
  ...
  const filteredRecommendations = useMemo(() => {
    ...
    return filterRecommendationsByCategory(
      allRecommendations,
